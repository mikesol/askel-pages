...
export default function ContactForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setSubmitting(true);
    setError("");
    const data: Record<string, string> = { source: pathname };
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              required
              className="bg-[#F1F2F4] border border-transparent rounded-xl px-4 py-3 font-inter text-sm text-[#14375A] placeholder-[#14375A]/30 outline-none focus:border-[#FF8F7A] focus:bg-white transition-colors"
            />
          </div>
          <div className="flex flex-col gap-1.5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select
            name="asia"
            required
            className="bg-[#F1F2F4] border border-transparent rounded-xl px-4 py-3 font-inter text-sm text-[#14375A] outline-none focus:border-[#FF8F7A] focus:bg-white transition-colors appearance-none"
          >
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            name="viesti"
            rows={3}
            placeholder="Kerro lisää tarpestasi..."
            className="bg-[#F1F2F4] border border-transparent rounded-xl px-4 py-3 font-inter text-sm text-[#14375A] placeholder-[#14375A]/30 outline-none focus:border-[#FF8F7A] focus:bg-white transition-colors resize-none"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full bg-[#FF8F7A] text-white font-sora font-bold py-3.5 rounded-full hover:bg-[#ff7a63] transition-colors mt-1 disabled:opacity-60"
        >
